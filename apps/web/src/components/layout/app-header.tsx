...
export function AppHeader() {
  ...
  return (
    <header className="sticky top-0 z-50 border-b border-white/8 bg-[#151719]/82 shadow-[0_10px_35px_-25px_black] backdrop-blur-2xl">
      <div className="mx-auto flex h-16 w-full max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
        <Link
          href="/stations"
          className="group flex items-center gap-2.5 font-bold tracking-tight text-foreground"
        >
          <span className="relative flex size-9 items-center justify-center overflow-hidden rounded-[11px] border border-white/10 bg-[#203234] text-emerald-300 shadow-[inset_0_1px_0_rgb(255_255_255/.08)]">
        ...
        <nav className="flex items-center gap-1 rounded-[13px] border border-white/8 bg-black/15 p-1 shadow-[inset_0_1px_0_rgb(255_255_255/.035)] backdrop-blur-xl">
          <Link
            href={"/stations"}
